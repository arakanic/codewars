...
// This function receives the following data structure representing the stairs Suzuki logged in a year with all data for the entire year as shown in the example below.

// stairs = [sunday,monday,tuesday,wednesday,thursday,friday,saturday]

// sunday = [6737, 7244, 5776, 9826, 7057, 9247, 5842, 5484, 6543, 5153, 6832, 8274, 7148, 6152, 5940, 8040, 9174, 7555, 7682, 5252, 8793, 8837, 7320, 8478, 6063, 5751, 9716, 5085, 7315, 7859, 6628, 5425, 6331, 7097, 6249, 8381, 5936, 8496, 6934, 8347, 7036, 6421, 6510, 5821, 8602, 5312, 7836, 8032, 9871, 5990, 6309, 7825]

// The function returns the 20 year estimate of the stairs climbed using the formula above and demonstrates the power of the reduce method.

function stairsIn20(s){
  return 20 * s.reduce((total, daily) => total + daily.reduce((day, steps) => day + steps, 0), 0);
}
